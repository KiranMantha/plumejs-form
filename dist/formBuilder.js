    ...
    switch (target.nodeName && target.nodeName.toLowerCase()) {
        ...
        case 'select': {
            ...
            var value = __spreadArray([], __read(options), false).filter(function (option) { return option.selected; })
                .map(function (option) { var _a; return (_a = option.value) !== null && _a !== void 0 ? _a : (option.textContent.match(/[^\x20\t\r\n\f]+/g) || []).join(' '); });
...
var FormBuilder = /** @class */ (function () {
    ...
    FormBuilder.prototype.reset = function () {
        ...
        try {
            for (var _b = __values(Object.entries(this._initialValues)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var _d = __read(_c.value, 2), key = _d[0], value = _d[1];
                var val = __spreadArray([], __read((Array.isArray(value) ? value : [value])), false);
                var validators = this._controls.get(key).validators;
                this._controls.set(key, {
    ...
    FormBuilder.prototype._checkValidity = function (controlName) {
        var e_4, _a;
        if (controlName) {
    ...
    FormBuilder.prototype._executeValidators = function (controlName) {
        var e_5, _a;
        var _b = this._controls.get(controlName), value = _b.value, validators = _b.validators;
        var errorMessage = '';
        try {
            for (var validators_1 = __values(validators), validators_1_1 = validators_1.next(); !validators_1_1.done; validators_1_1 = validators_1.next()) {
                ...
                var validity = isFunction(validator)
                    ? validator(value)
                    : validator.rule(value);
                if (validity !== null) {
                    if (this._errors.has(controlName)) {
                        this._errors.set(controlName, __assign(__assign({}, this._errors.get(controlName)), validity));
                    }
                    else {
